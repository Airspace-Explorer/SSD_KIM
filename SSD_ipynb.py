...
img_path= "/local_datasets/aircraftAndBird/training2/images" 
...
cfg.data.train.dataset.img_prefix = data_root + 'training2/images'
...
cfg.dump('SSD_config.py') # 수정된 config 파일 저장
